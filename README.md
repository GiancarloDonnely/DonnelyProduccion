...
| Pestaña | Contenido |
|---|---|
| ⚙️ Capacidad & Ociosidad | Medidor (gauge) de capacidad, utilización vs. capacidad demostrada, capacidad ociosa, tiempos muertos, mapa de calor y matriz de decisión |
| ✅ Pedidos Entregados | Pedidos finalizados agrupados por NP, con días de entrega y % de cumplimiento vs. fecha comprometida |
| ⏳ Pendientes | Pedidos sin despachar priorizados por urgencia, con dos vistas: por pedido (agrupado por NP) y por línea (con código y descripción del producto) |
| 🧵 Fabricación Propia | Paso por corte y taller con días de confección (calculados sobre la salida real de taller), más las líneas de P1 sin taller asignado en P2 |
| 🔎 Trazabilidad | Recorrido de un pedido (NP) por las planillas, con filtro por estado (todos / finalizados / pendientes) |
