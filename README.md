...
| Pestaña | Contenido |
|---|---|
| ⚙️ Capacidad & Ociosidad | Medidor (gauge) de capacidad, utilización vs. capacidad demostrada, capacidad ociosa en unidades, tiempos muertos entre etapas, mapa de calor mensual y matriz de decisión |
| 🦺 Buzo Desechable | Análisis dedicado del buzo desechable (Tyvek/Proman): volumen mensual, cadena de suministro, lead time e impacto en la capacidad total |
